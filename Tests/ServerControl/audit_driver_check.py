...
def main():
    ...
    blobs = {'server-control': '2daa9e557bc125d70d17e1ef07d5247083c2d789',
             'settings-persistence': 'a72a0e725e808e90d096cec2e1619cd3251af8b1'}
    check('Build/build.sh', ['SUCCESS.txt', 'sdk-success.txt'], blobs[name], name)
    check('Build/check_swift_sdk.sh', ['sdk-success.txt'], '2397a0981be7d1a929287fe1dcfd46c82a6e9ba7', name)
